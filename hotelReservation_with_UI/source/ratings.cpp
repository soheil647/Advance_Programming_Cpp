...
void Ratings::show_rating() {
    ...
    cout << "overall_rating: " <<  overall_rating << endl;
}
...
double Ratings::find_weighted_overall(const std::vector<double>& weights) {
    vector<double> x = {location_rating, cleanliness_rating, staff_rating, facilities_rating, value_for_money_rating};
    double sum = 0;
    double weight_sum = 0;
...
//    cout << "sum: " << sum << " " << "weight_sum: " << weight_sum << endl;
