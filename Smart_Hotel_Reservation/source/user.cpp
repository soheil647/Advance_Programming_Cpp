...
void User::sort_by_standard_price(const std::string &order) {
    switch (resolve_sort_order(order)){
        case ascending: {
            sort_function = [](Hotel *lhs, Hotel *rhs) { return lhs->get_standard_price() < rhs->get_standard_price(); };
            break;
        }
        case descending: {
            sort_function = [](Hotel *lhs, Hotel *rhs) { return lhs->get_standard_price() > rhs->get_standard_price(); };
...
void User::sort_by_deluxe_price(const std::string &order) {
    switch (resolve_sort_order(order)){
        case ascending: {
            sort_function = [](Hotel *lhs, Hotel *rhs) { return lhs->get_deluxe_price() < rhs->get_deluxe_price(); };
            break;
        }
        case descending: {
            sort_function = [](Hotel *lhs, Hotel *rhs) { return lhs->get_deluxe_price() > rhs->get_deluxe_price(); };
...
void User::sort_by_luxury_price(const std::string &order) {
    switch (resolve_sort_order(order)){
        case ascending: {
            sort_function = [](Hotel *lhs, Hotel *rhs) { return lhs->get_luxury_price() < rhs->get_luxury_price(); };
            break;
        }
        case descending: {
            sort_function = [](Hotel *lhs, Hotel *rhs) { return lhs->get_luxury_price() > rhs->get_luxury_price(); };
...
void User::sort_by_premium_price(const std::string &order) {
    switch (resolve_sort_order(order)){
        case ascending: {
            sort_function = [](Hotel *lhs, Hotel *rhs) { return lhs->get_premium_price() < rhs->get_premium_price(); };
            break;
        }
        case descending: {
            sort_function = [](Hotel *lhs, Hotel *rhs) { return lhs->get_premium_price() > rhs->get_premium_price(); };
...
void User::sort_by_average_price(const std::string &order) {
    switch (resolve_sort_order(order)){
        case ascending: {
            sort_function = [](Hotel *lhs, Hotel *rhs) { return lhs->get_average_price() < rhs->get_average_price(); };
            break;
        }
        case descending: {
            sort_function = [](Hotel *lhs, Hotel *rhs) { return lhs->get_average_price() > rhs->get_average_price(); };
...
void User::add_rating(const std::string& hotel_id, float overall_rating) {
    given_rating.push_back(new Ratings(hotel_id, overall_rating));
}
